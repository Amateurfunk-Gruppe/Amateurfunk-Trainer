...
function beschreibung(namen, version, neue) {
  ...
  if (win) {
    s += '**Windows** \u2014 `' + win + '` auspacken, den Ordner hinlegen, wo du willst '
      ...
      + 'Entfernen den Ordner l\u00f6schen. **Nicht** *Source code (zip)* weiter unten '
      + 'nehmen \u2014 das ist der Quelltext ohne Node und ohne Stimmen; damit fragt der '
      + 'Trainer beim Start nach Node.js und startet danach nicht.\n\n'
