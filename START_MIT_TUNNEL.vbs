' ================================================================
'  START_MIT_TUNNEL.vbs - Trainer starten UND den Tunnel gleich mit
' ================================================================
'  Damit ist dieser Rechner ueber eine oeffentliche Internet-Adresse
'  erreichbar, solange der Trainer laeuft. Nur benutzen, wenn du
'  wirklich einen Gruppenraum anbietest.
'
'  DAS WAR BIS ZUM 01.09.2026 KAPUTT: Diese Datei war Zeichen fuer
'  Zeichen mit START.vbs identisch und startete deshalb gar keinen
'  Tunnel. Sie sah nur so aus. Der Server erkennt den Wunsch an
...
WshShell.Environment("PROCESS")("AFU_TUNNEL")  = "1"
